...
const defaults=[['pushup','プッシュアップ',10,2],['bulgarian','ブルガリアンスクワット（左右各）',15,2],['roller','腹筋ローラー',6,2],['legraise','足上げ腹筋',10,2]];
...
async function load(){
 ...
 if(new Date(date+'T12:00:00+09:00').getUTCDay()!==6) await insert(defaults.map(d=>rowData(...d,'default:'+d[0])));
